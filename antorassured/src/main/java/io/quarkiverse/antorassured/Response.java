...
public class Response {
    ...
    public Document bodyAsHtmlDocument() {
        return bodyAs(Document.class, resp -> Parser.htmlParser().parseInput(resp.statusMessage, resp.uri));
    }

    public String bodyAsString() {
        return bodyAs(String.class, resp -> new String(resp.body, resp.charset));
    }
